...
- After selecting the workflow owner, apply [`.agents/skills/reference.md` § Agent routing](./.agents/skills/reference.md#agent-routing); model choice never changes skill ownership or gates.
