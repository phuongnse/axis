...
//    Schemas/DataRecordCreatedEvent.avsc.
// </auto-generated>
// ------------------------------------------------------------------------------
namespace axis.datamodeling.events
{
    ...
    public partial class DataRecordCreatedEvent : global::Avro.Specific.ISpecificRecord
    {
        public static global::Avro.Schema _SCHEMA = global::Avro.Schema.Parse(
            @"{""type"":""record"",""name"":""DataRecordCreatedEvent"",""namespace"":""axis.datamodeling.events"",""fields"":[{""name"":""recordId"",""type"":""string""},{""name"":""modelId"",""type"":""string""},{""name"":""organizationId"",""type"":""string""}]}");
