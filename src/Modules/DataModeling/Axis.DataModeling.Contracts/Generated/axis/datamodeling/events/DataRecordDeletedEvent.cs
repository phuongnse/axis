...
namespace axis.datamodeling.events
{
    ...
    public partial class DataRecordDeletedEvent : global::Avro.Specific.ISpecificRecord
    {
        public static global::Avro.Schema _SCHEMA = global::Avro.Schema.Parse(
            @"{""type"":""record"",""name"":""DataRecordDeletedEvent"",""namespace"":""axis.datamodeling.events"",""fields"":[{""name"":""recordId"",""type"":""string""},{""name"":""modelId"",""type"":""string""},{""name"":""workspaceId"",""type"":""string""}]}");
