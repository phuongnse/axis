...
// Schemas/FormTaskSubmittedEvent.avsc.
// </auto-generated>
// ------------------------------------------------------------------------------
namespace axis.formbuilder.events
{
    ...
    public partial class FormTaskSubmittedEvent : global::Avro.Specific.ISpecificRecord
    {
        public static global::Avro.Schema _SCHEMA = global::Avro.Schema.Parse(
            @"{""type"":""record"",""name"":""FormTaskSubmittedEvent"",""namespace"":""axis.formbuilder.events"",""fields"":[{""name"":""formSubmissionId"",""type"":""string""},{""name"":""formDefinitionId"",""type"":""string""},{""name"":""teamAccountId"",""type"":""string""},{""name"":""executionId"",""type"":""string""},{""name"":""executionStepId"",""type"":""string""},{""name"":""submittedDataJson"",""type"":""string""}]}");
        ...
        public virtual global::Avro.Schema Schema => FormTaskSubmittedEvent._SCHEMA;
