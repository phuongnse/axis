...
/// <summary>Returns all forms for the team account as a flat list for use in workflow form-step pickers.</summary>
    ...
    : IQueryHandler<GetFormPickerQuery, IReadOnlyList<GetFormPickerDto>>
{
    ...
    {
        IReadOnlyList<FormDefinition> all = await formRepo.GetAllAsync(query.TeamAccountId, cancellationToken);
