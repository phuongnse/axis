...
/// <summary>Resolves effective RBAC permissions for a user within a tenant (gRPC + internal sync).</summary>
public sealed record GetUserPermissionsQuery(Guid UserId, Guid tenantId)
