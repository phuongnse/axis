...
public sealed class CompensateWorkspaceContextTransitionHandler(
    IWorkspaceContextTransitionRepository transitions,
    IIdentityAuditOutbox audit,
    IUnitOfWork uow,
    TimeProvider clock)
    : ICommandHandler<CompensateWorkspaceContextTransitionCommand, WorkspaceContextTransitionDto>
{
    public async Task<Result<WorkspaceContextTransitionDto>> Handle(
        CompensateWorkspaceContextTransitionCommand command,
