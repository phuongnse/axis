...
internal sealed class ServiceIdentityConfiguration : IEntityTypeConfiguration<ServiceIdentity>
{
    public void Configure(EntityTypeBuilder<ServiceIdentity> b)
    {
        ...
        b.Property(x => x.CreatedAt).HasColumnName("created_at"); b.Property(x => x.UpdatedAt).HasColumnName("updated_at"); b.Property(x => x.RevokedAt).HasColumnName("revoked_at"); b.Property(x => x.Revision).HasColumnName("revision").IsConcurrencyToken();
        ConfigureMetadata(b);
    ...
    {
        b.Property<ActorKind?>("CreatedByKind").HasColumnName("created_by_kind").HasConversion<string>().HasMaxLength(32);
        b.Property<Guid?>("CreatedBySubjectId").HasColumnName("created_by_subject_id");
        b.Property<string?>("CreatedByDisplayName").HasColumnName("created_by_display_name").HasMaxLength(ActorSnapshot.MaximumDisplayNameLength);
        b.Property<ActorKind?>("UpdatedByKind").HasColumnName("updated_by_kind").HasConversion<string>().HasMaxLength(32);
        b.Property<Guid?>("UpdatedBySubjectId").HasColumnName("updated_by_subject_id");
        b.Property<string?>("UpdatedByDisplayName").HasColumnName("updated_by_display_name").HasMaxLength(ActorSnapshot.MaximumDisplayNameLength);
