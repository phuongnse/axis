...
internal sealed class WorkspaceMembershipConfiguration : IEntityTypeConfiguration<WorkspaceMembership>
{
    public void Configure(EntityTypeBuilder<WorkspaceMembership> builder)
    {
        ...
        builder.Property<ActorKind?>("CreatedByKind").HasColumnName("created_by_kind").HasConversion<string>().HasMaxLength(32); builder.Property<Guid?>("CreatedBySubjectId").HasColumnName("created_by_subject_id"); builder.Property<string?>("CreatedByDisplayName").HasColumnName("created_by_display_name").HasMaxLength(ActorSnapshot.MaximumDisplayNameLength); builder.Property<ActorKind?>("UpdatedByKind").HasColumnName("updated_by_kind").HasConversion<string>().HasMaxLength(32); builder.Property<Guid?>("UpdatedBySubjectId").HasColumnName("updated_by_subject_id"); builder.Property<string?>("UpdatedByDisplayName").HasColumnName("updated_by_display_name").HasMaxLength(ActorSnapshot.MaximumDisplayNameLength); builder.Ignore(x => x.CreatedBy); builder.Ignore(x => x.UpdatedBy);
