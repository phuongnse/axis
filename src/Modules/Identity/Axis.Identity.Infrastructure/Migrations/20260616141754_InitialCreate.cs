...
namespace Axis.Identity.Infrastructure.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "workspace_module_provisions",
                columns: table => new
                {
                    workspace_id = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_workspace_module_provisions", x => new { x.workspace_id, x.module });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Workspaces_subscription_plans_subscription_plan_id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Workspace_membership_roles", x => new { x.membership_id, x.role_id });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                name: "Workspace_plan_change_logs",
                columns: table => new
                {
                    id = table.Column<Guid>(type: "uuid", nullable: false),
                    workspace_id = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Workspace_plan_change_logs", x => x.id);
                    table.ForeignKey(
                        name: "FK_Workspace_plan_change_logs_Workspaces_workspace_id",
                        column: x => x.workspace_id,
                        principalTable: "Workspaces",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Workspace_plan_change_logs_subscription_plans_new_plan_id",
                        column: x => x.new_plan_id,
                        principalTable: "subscription_plans",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Workspace_plan_change_logs_subscription_plans_previous_plan~",
            ...
            migrationBuilder.CreateTable(
                name: "Workspace_registration_tokens",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    workspace_id = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Workspace_registration_tokens", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Workspace_registration_tokens_Workspaces_workspace_id",
                        column: x => x.workspace_id,
                        principalTable: "Workspaces",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Workspace_plan_change_logs_new_plan_id",
                table: "Workspace_plan_change_logs",
                column: "new_plan_id");

            migrationBuilder.CreateIndex(
                name: "IX_Workspace_plan_change_logs_previous_plan_id",
                table: "Workspace_plan_change_logs",
                column: "previous_plan_id");

            migrationBuilder.CreateIndex(
                name: "IX_Workspace_plan_change_logs_workspace_id",
                table: "Workspace_plan_change_logs",
                column: "workspace_id");

            migrationBuilder.CreateIndex(
                name: "IX_Workspace_registration_tokens_TokenHash",
                table: "Workspace_registration_tokens",
                column: "TokenHash",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Workspace_registration_tokens_workspace_id_Purpose",
                table: "Workspace_registration_tokens",
            ...
            migrationBuilder.CreateIndex(
                ...
                unique: true,
                filter: "owner_user_id IS NOT NULL AND type = 'Personal'");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Workspaces_subscription_plan_id",
                table: "Workspaces",
