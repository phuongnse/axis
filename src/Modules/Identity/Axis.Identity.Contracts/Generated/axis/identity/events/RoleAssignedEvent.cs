...
namespace axis.identity.events
{
    ...
    public partial class RoleAssignedEvent : global::Avro.Specific.ISpecificRecord
    {
        public static global::Avro.Schema _SCHEMA = global::Avro.Schema.Parse(
            @"{""type"":""record"",""name"":""RoleAssignedEvent"",""namespace"":""axis.identity.events"",""fields"":[{""name"":""userId"",""type"":""string""},{""name"":""organizationId"",""type"":""string""},{""name"":""roleId"",""type"":""string""}]}");
