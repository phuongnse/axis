...
public sealed class ArchiveWorkflowHandler(IWorkflowRepository workflowRepo, IUnitOfWork uow)
    : ICommandHandler<ArchiveWorkflowCommand>
{
    public async Task<Result> Handle(ArchiveWorkflowCommand command, CancellationToken cancellationToken)
    {
