...
{
    /// <inheritdoc />
    public partial class AddRuleSearchIndex : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.AddColumn<string>(
                ...
                type: "text",
                nullable: true,
                computedColumnSql: "axis_unaccent(lower(coalesce(name, '') || ' ' || coalesce(description, '') || ' ' || coalesce(definition_key, '') || ' ' || coalesce(context_key, '')))",
                stored: true);
            ...
            migrationBuilder.AddColumn<NpgsqlTsVector>(
                ...
                type: "tsvector",
                nullable: true,
                computedColumnSql: "to_tsvector('simple', axis_unaccent(lower(coalesce(name, '') || ' ' || coalesce(description, '') || ' ' || coalesce(definition_key, '') || ' ' || coalesce(context_key, ''))))",
                stored: true);
