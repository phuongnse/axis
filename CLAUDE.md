...
**Wireframes:** use-case assets under `docs/use-cases/{domain}/{use-case}/`; shared kit under `docs/shared-assets/wireframes/`. Link rows in each use-case file; regenerate with `docs/scripts/generate-wireframes.ps1`. Kit rules: [`wireframes.md`](docs/playbooks/wireframes.md).
