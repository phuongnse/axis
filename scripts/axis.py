...
ENFORCEMENT_TRUTH_REQUIRED_SNIPPETS = [
    ...
    (
        ...
        [
            ...
            ('fresh.Should().Contain("\\"tenantName\\"");', "OpenAPI test asserts camelCase wire shape"),
            ('fresh.Should().NotContain("\\"tenant_name\\"");', "OpenAPI test rejects snake_case wire drift"),
        ],
    ),
    (
