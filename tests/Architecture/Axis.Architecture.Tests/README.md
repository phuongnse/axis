...
3. If the module provisions workspace schema: add `WorkspaceVerifiedHandler` and update `WorkspaceModuleNames` — see [`WorkspaceProvisioningConventionTests`](./WorkspaceProvisioningConventionTests.cs) and [repo-layout-discovery.md § A](../../../docs/playbooks/repo-layout-discovery.md).
