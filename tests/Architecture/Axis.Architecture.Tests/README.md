...
1. Add `"NewModule"` to [`Conventions.ModuleNames`](./Conventions.cs).
...
3. Run `dotnet test` against this project — all theory tests will now generate cases for the new module automatically.
