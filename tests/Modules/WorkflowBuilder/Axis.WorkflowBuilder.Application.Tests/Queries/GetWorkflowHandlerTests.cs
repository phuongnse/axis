...
public class GetWorkflowHandlerTests
{
    ...
    public async Task Handle_WhenWorkflowExists_ReturnsDetailDto()
    {
        ...
        WorkflowDetailDto? dto = await _handler.Handle(new GetWorkflowQuery(wf.Id, TenantId), CancellationToken.None);
    ...
    public async Task Handle_WhenWorkflowNotFound_ReturnsNull()
    {
        ...
        WorkflowDetailDto? dto = await _handler.Handle(
            new GetWorkflowQuery(Guid.NewGuid(), TenantId), CancellationToken.None);
    ...
    public async Task Handle_WhenWorkflowBelongsToAnotherTenant_ReturnsNull()
    {
        ...
        WorkflowDetailDto? dto = await _handler.Handle(
            new GetWorkflowQuery(wf.Id, otherTenantId), CancellationToken.None);
