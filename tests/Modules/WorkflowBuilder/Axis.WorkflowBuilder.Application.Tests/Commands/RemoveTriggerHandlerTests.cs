...
public class RemoveTriggerHandlerTests
{
    ...
    public async Task Handle_WhenTriggerExists_RemovesAndSaves()
    {
        ...
        Result result = await _handler.Handle(
            new RemoveTriggerCommand(wf.Id, WorkspaceId, TriggerType.Manual), CancellationToken.None);
    ...
    public async Task Handle_WhenWorkflowNotFound_ReturnsNotFound()
    {
        ...
        Result result = await _handler.Handle(
            new RemoveTriggerCommand(Guid.NewGuid(), WorkspaceId, TriggerType.Manual), CancellationToken.None);
    ...
    public async Task Handle_WhenWorkflowBelongsToAnotherWorkspace_ReturnsNotFound()
    {
        ...
        Result result = await _handler.Handle(
            new RemoveTriggerCommand(wf.Id, otherWorkspaceId, TriggerType.Manual), CancellationToken.None);
