...
public class RemoveTriggerHandlerTests
{
    ...
    public async Task Handle_WhenTriggerExists_RemovesAndSaves()
    {
        ...
        Result result = await _handler.Handle(
            new RemoveTriggerCommand(wf.Id, TenantId, TriggerType.Manual), CancellationToken.None);
    ...
    public async Task Handle_WhenWorkflowNotFound_ReturnsNotFound()
    {
        ...
        Result result = await _handler.Handle(
            new RemoveTriggerCommand(Guid.NewGuid(), TenantId, TriggerType.Manual), CancellationToken.None);
    ...
    public async Task Handle_WhenWorkflowBelongsToAnotherTenant_ReturnsNotFound()
    {
        ...
        Result result = await _handler.Handle(
            new RemoveTriggerCommand(wf.Id, otherTenantId, TriggerType.Manual), CancellationToken.None);
