...
public class ArchiveWorkflowHandlerTests
{
    ...
    public async Task Handle_WhenWorkflowIsActive_ArchivesAndSaves()
    {
        ...
        Result result = await _handler.Handle(new ArchiveWorkflowCommand(wf.Id, TeamAccountId), CancellationToken.None);
    ...
    public async Task Handle_WhenWorkflowNotFound_ReturnsNotFound()
    {
        ...
        Result result = await _handler.Handle(new ArchiveWorkflowCommand(Guid.NewGuid(), TeamAccountId), CancellationToken.None);
    ...
    public async Task Handle_WhenWorkflowBelongsToAnotherTeamAccount_ReturnsNotFound()
    {
        ...
        Result result = await _handler.Handle(new ArchiveWorkflowCommand(wf.Id, otherTeamAccountId), CancellationToken.None);
