...
public class WorkflowDefinitionTests
{
    ...
    [Fact]
    public void WorkflowDefinition_WhenCreated_SetsNameDescriptionTenantIdAndDraftStatus()
    {
        WorkflowDefinition wf = WorkflowDefinition.Create("Invoice Approval", "Approves invoices", TenantId, UserId);
    ...
    {
        WorkflowDefinition wf = WorkflowDefinition.Create("My Workflow", null, TenantId, UserId);
    ...
    {
        Func<WorkflowDefinition> act = () => WorkflowDefinition.Create(name, null, TenantId, UserId);
    ...
    public void WorkflowDefinition_WhenNameExceeds200Chars_ThrowsArgumentException()
    {
        ...
        Func<WorkflowDefinition> act = () => WorkflowDefinition.Create(longName, null, TenantId, UserId);
        act.Should().Throw<ArgumentException>();
    }
    ...
    {
        WorkflowDefinition wf = WorkflowDefinition.Create("Old Name", null, TenantId, UserId);
