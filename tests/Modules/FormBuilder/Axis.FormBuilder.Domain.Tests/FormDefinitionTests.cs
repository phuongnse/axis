...
public class FormDefinitionTests
{
    ...
    {
        var form = FormDefinition.Create("Employee Intake", "New hire form", OrgId);
    ...
    {
        var act = () => FormDefinition.Create(name, null, OrgId);
    ...
    [Fact]
    public void Delete_soft_deletes_and_raises_event()
    {
        var form = FormDefinition.Create("Employee Intake", null, OrgId);
        form.Delete();
