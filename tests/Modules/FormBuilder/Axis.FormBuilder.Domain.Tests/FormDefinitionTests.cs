...
public class FormDefinitionTests
{
    ...
    {
        FormDefinition form = FormDefinition.Create("Employee Intake", "New hire form", OrgId, UserId);
    ...
    {
        Func<FormDefinition> act = () => FormDefinition.Create(name, null, OrgId, UserId);
