...
public class GetFormTaskByTokenHandlerTests
{
    ...
    public async Task Handle_WhenFormNotFound_ReturnsNull()
    {
        ...
        _submissionRepo
            ...
            .Returns(submission);
        _formRepo
            .GetByIdAsync(submission.FormDefinitionId, submission.TeamAccountId, Arg.Any<CancellationToken>())
    ...
    public async Task Handle_WhenValid_ReturnsDtoWithFieldsOrderedByDisplayOrder()
    {
        ...
        FormDefinition form = FormDefinition.Create("Onboarding", "desc", TeamAccountId, "user");
