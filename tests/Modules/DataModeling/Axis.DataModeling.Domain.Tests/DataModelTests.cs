...
public class DataModelTests
{
    ...
    [Fact]
    public void DataModel_WhenCreated_SetsNameDescriptionIconColorAndWorkspaceId()
    {
        DataModel model = DataModel.Create("Invoice", "Invoicing model", "file-text", "#3B82F6", WorkspaceId, UserId);
        ...
        model.workspaceId.Should().Be(WorkspaceId);
    ...
    {
        Func<DataModel> act = () => DataModel.Create(name, null, null, null, WorkspaceId, UserId);
