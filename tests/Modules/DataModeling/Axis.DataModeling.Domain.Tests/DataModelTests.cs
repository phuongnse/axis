...
public class DataModelTests
{
    ...
    [Fact]
    public void DataModel_WhenCreated_SetsNameDescriptionIconColorAndTeamAccountId()
    {
        DataModel model = DataModel.Create("Invoice", "Invoicing model", "file-text", "#3B82F6", TeamAccountId, UserId);
        ...
        model.TeamAccountId.Should().Be(TeamAccountId);
    ...
    {
        Func<DataModel> act = () => DataModel.Create(name, null, null, null, TeamAccountId, UserId);
