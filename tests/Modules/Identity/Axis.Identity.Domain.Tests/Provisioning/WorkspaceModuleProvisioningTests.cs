...
public sealed class WorkspaceModuleProvisioningTests
{
    [Fact]
    public void CreatePending_WhenModuleEmpty_Throws()
    {
        Action act = () => WorkspaceModuleProvisioning.CreatePending(Guid.NewGuid(), "  ");
    ...
    {
        WorkspaceModuleProvisioning row = WorkspaceModuleProvisioning.CreatePending(Guid.NewGuid(), "datamodeling");
