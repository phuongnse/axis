...
2. Establish purpose, actor, trigger, flows, boundaries, decisions, failure behavior, and any evidence-backed compatibility constraint from the source priority in [AGENTS.md](../../../AGENTS.md). When the product phase permits a clean replacement, state the retired behavior and do not invent an overlap period.
