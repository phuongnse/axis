...
| Define, verify, enforce, or change the UI constitution and view composition | [axis-ui-system/SKILL.md](./axis-ui-system/SKILL.md) | Owns semantic roles and values, surface archetypes, shared visual mappings, active-surface registry, conformance evidence, and safe replacement |
