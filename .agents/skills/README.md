...
| Define, implement, freeze, or change the visual system and view composition | [axis-ui-system/SKILL.md](./axis-ui-system/SKILL.md) | Owns visual language, semantic interaction, page archetypes, shared visual APIs, golden references, active UI phase, and safe replacement |
