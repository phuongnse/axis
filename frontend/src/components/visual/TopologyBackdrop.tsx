...
export function TopologyBackdrop({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      <div className="absolute right-[-12%] top-[12%] h-[44%] w-[52%] skew-x-12 bg-gradient-to-l from-chart-2/[0.14] via-chart-2/[0.06] to-transparent blur-2xl dark:from-chart-2/[0.11] dark:via-chart-2/[0.04]" />
