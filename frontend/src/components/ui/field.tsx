...
function FieldTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="field-label"
      className={cn(
        "flex w-fit items-center gap-2 text-sm font-medium group-data-[disabled=true]/field:text-muted-foreground group-data-[disabled=true]/field:opacity-100 group-has-disabled/field:text-muted-foreground group-has-disabled/field:opacity-100 group-has-data-disabled/field:text-muted-foreground group-has-data-disabled/field:opacity-100",
        className
      )}
      {...props}
    />
