...
export function TopologyBackdrop({ className }: { className?: string }) {
  return (
    ...
    >
      <div className="absolute inset-0 bg-gradient-to-br from-primary/10 via-background to-accent/10 dark:from-primary/10 dark:via-background dark:to-accent/10" />
