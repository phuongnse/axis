...
export function WorkspaceProvisioningPage() {
  ...
  const teamAccountName = context?.teamAccountName ?? t('provisioning.teamAccountFallback');
  ...
  if (loading && !status) {
    return (
      <AuthCard title={t('provisioning.loadingTitle', { teamAccountName })}>
            ...
            <div className="space-y-2">
              <h1 className="text-2xl font-semibold tracking-tight text-foreground">
                {failed
                  ...
                  : t('provisioning.loadingTitle', { teamAccountName })}
              </h1>
              <p className="text-sm text-muted-foreground">
        ...
        <div className="axis-grid-strong space-y-5 bg-background/70 p-6">
          <div className="flex items-center justify-between gap-3">
            <div>
              ...
              <p className="mt-1 text-sm font-medium text-foreground">{teamAccountName}</p>
            </div>
            <span
              className={cn(
