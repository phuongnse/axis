...
export const axisConsumerContracts = [
  ...
  },
  {
    ...
    owner: 'auth',
    readiness: 'ready',
    primitives: ['AuthCard', 'Button', 'FormField', 'Input', 'PreferenceControls'],
  ...
  },
  {
    ...
    owner: 'auth',
    readiness: 'candidate',
    primitives: ['AuthCard', 'Button', 'FormField', 'Input'],
  ...
  },
  {
    ...
    owner: 'auth',
    readiness: 'ready',
    primitives: ['AuthCard', 'Badge', 'Button', 'FlowTrace', 'Panel'],
  ...
  },
  {
    ...
    owner: 'layout',
    readiness: 'ready',
    primitives: ['Button', 'Input', 'navigation-shell'],
  ...
  },
  {
    ...
    owner: 'dashboard',
    readiness: 'candidate',
    primitives: ['Badge', 'EmptyState', 'Panel', 'Progress'],
