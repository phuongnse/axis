...
| AT-002, AT-003 | `frontend/tests/module-navigation.test.tsx` | `python scripts/axis.py frontend test tests/module-navigation.test.tsx` |
| AT-004 | `frontend/e2e/app-frame.pw.ts` | `python scripts/axis.py local-dev e2e -- e2e/app-frame.pw.ts` |
| AT-005 | `frontend/src/lib/module-navigation.ts`, `frontend/src/lib/module-navigation-registry.ts`, `frontend/src/components/shared/ModuleNavigation.tsx`, `frontend/src/features/business-objects/navigation.ts`, `frontend/src/features/rules/navigation.ts`, `frontend/src/features/preferences/translations.ts` | `python scripts/axis.py frontend ci` |
