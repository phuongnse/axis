...
- The four canonical EN Account baselines were regenerated through the bounded Axis snapshot output, inspected across light/dark × desktop/compact, then verified by the comparison run above. VI behavior and responsive layout remain verified by structural browser assertions without a duplicate golden-image matrix.
