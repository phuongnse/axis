...
- The four canonical EN Account baselines were regenerated through the bounded Axis snapshot output, inspected across light/dark × desktop/compact, then verified by the comparison run above. The shared browser evidence helper rejects perceptual capture outside the product default language.
