...
| AT-007 | `frontend/src/components/shared/data-table/DataTable.tsx`, `frontend/src/components/shared/data-table/DataTableToolbar.tsx`, `frontend/src/components/shared/data-table/filtering.ts`, `frontend/src/components/shared/data-table/types.ts`, `frontend/src/features/rules/components/RulesPage.tsx`, `frontend/src/features/preferences/translations.ts` | `python scripts/axis.py frontend ci` |
