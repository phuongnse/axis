...
| AT-004 | `frontend/e2e/manage-rules.pw.ts`, `frontend/e2e/define-business-object.pw.ts` | `python scripts/axis.py local-dev e2e -- e2e/manage-rules.pw.ts -g "catalog"`; `python scripts/axis.py local-dev e2e -- e2e/define-business-object.pw.ts -g "catalog search"` |
