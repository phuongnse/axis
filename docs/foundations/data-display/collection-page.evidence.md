...
| AT-004 | `frontend/e2e/manage-rules.pw.ts`, `frontend/e2e/define-business-object.pw.ts` | `python scripts/axis.py frontend script test:e2e -- e2e/manage-rules.pw.ts e2e/define-business-object.pw.ts` |
