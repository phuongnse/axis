...
| DDD aggregate conventions | [docs/ARCHITECTURE.md](./ARCHITECTURE.md) | Domain aggregate roots | Architecture tests and review | Public mutable setters and public parameterless constructors are rejected; aggregate boundaries and invariant completeness still require review | Partial |
| CQRS request markers | [`.agents/skills/axis-module-architecture/SKILL.md`](../.agents/skills/axis-module-architecture/SKILL.md) | Application request types | Architecture tests and review | Request types must use Axis `ICommand`, `ICommand<T>`, or `IQuery<T>` markers; semantic command/query choice still requires review | Partial |
| Tactical module pattern readiness | [`.agents/skills/axis-module-patterns/SKILL.md`](../.agents/skills/axis-module-patterns/SKILL.md) | Aggregate, value object, strongly typed ID, Unit of Work, optimistic concurrency, read model, or event pattern implementation | Design Gate and review | Pattern output records Adopt/Reject/Blocked decisions before implementation; deterministic checks are added only for reusable machine-checkable rules | Review-only |
| Unit of Work repository boundary | [`.agents/skills/axis-module-patterns/SKILL.md`](../.agents/skills/axis-module-patterns/SKILL.md) | Module Infrastructure repositories | Architecture tests and review | Repositories cannot expose commit-style methods or `IQueryable`; transaction semantics and save timing still require review/tests | Partial |
...
| Event dispatch/outbox/inbox boundary | [`.agents/skills/axis-module-patterns/SKILL.md`](../.agents/skills/axis-module-patterns/SKILL.md) | Domain, integration, outbox, inbox, or consumed event changes | Design Gate and review | Domain event collection exists; dispatch, outbox, inbox, retries, and idempotent consumption require explicit architecture decisions before code | Review-only |
| Module architecture readiness | [`.agents/skills/axis-module-architecture/SKILL.md`](../.agents/skills/axis-module-architecture/SKILL.md) | New module, module boundary, foundational DDD/CQRS/event change | Design Gate and review | Readiness output records boundary, DDD, CQRS, persistence, events, and enforcement before implementation | Review-only |
| Event sourcing introduction | [`.agents/skills/axis-module-architecture/SKILL.md`](../.agents/skills/axis-module-architecture/SKILL.md) | Event store, stream replay, projection rebuild, event versioning, snapshotting, or operational replay semantics | Design Gate and review | No event-sourcing implementation exists; introduction requires explicit sign-off and new deterministic checks | Review-only |
