...
**F03 tenant isolation:** ✅ `TenantSchemaInterceptor`, `TenantOrganizationAccessMiddleware`, cross-tenant API + per-schema integration tests — see [E01 F03](./epics/E01-platform-foundation/features/F03-tenant-isolation.md).
