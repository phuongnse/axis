...
> 📝 **Docs-first next scope:** E02 F06 Localization & Theming defines frontend ACs for EN/VI, light/dark/system mode, and rollout rules before implementation starts.
