...
**F03 tenant isolation:** ✅ `TenantSchemaInterceptor`, `TenantOrganizationAccessMiddleware` (403 for missing/archived/not-ready orgs), cross-tenant API tests — see [E01 F03](./epics/E01-platform-foundation/features/F03-tenant-isolation.md).
