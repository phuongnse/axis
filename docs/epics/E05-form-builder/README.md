...
| Application | ⚠️ Partial | CreateForm, DeleteForm commands. Missing: UpdateForm; GetForms, GetFormById queries; field management commands (AddField, RemoveField, ReorderFields) |
