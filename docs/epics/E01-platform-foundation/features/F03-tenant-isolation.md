...
> **Implementation status** — Domain: N/A | Application: ✅ (`ITenantContext`) | Infrastructure: ⚠️ | API: ⚠️ | Frontend: N/A
...
> **Implementation status** — Domain: N/A | Application: ✅ | Infrastructure: ⚠️ | API: ⚠️ | Frontend: N/A
