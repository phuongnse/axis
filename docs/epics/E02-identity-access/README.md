...
| Frontend | ⚠️ Partial | Phase 1: PKCE login (`/login`, `/callback`), `_authenticated` guard, minimal `AppShell`, Bearer + 401 redirect. Gaps: wireframe-complete login/shell, silent refresh, register/forgot-password routes, Vitest |
