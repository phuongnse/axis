...
- Use `python scripts/axis.py migration add <audit|identity|business-objects|rules> <PascalCaseName>` to scaffold a migration with the repository-owned project, context, output, and design-time environment.
