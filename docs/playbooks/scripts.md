...
- CodeRabbit remains an external prerequisite: review setup diagnoses it but does not install or authenticate it. Authentication for GitHub CLI and CodeRabbit always remains interactive and outside setup.
