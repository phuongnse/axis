...
Review checklist only. Workflow lives in repo skills ([`.cursor/skills/README.md`](../../.cursor/skills/README.md)); enforcement status lives in [docs/ENFORCEMENT.md](../ENFORCEMENT.md); command behavior lives in [docs/playbooks/scripts.md](./scripts.md).
