...
- Large features: if the use case spans multiple PRs, follow [pr-slicing.md § Agent workflow](./pr-slicing.md#agent-workflow) — each slice updates callouts for what **that** slice ships; defer remaining bullets explicitly.
