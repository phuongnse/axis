...
Frontend implementation rules live in [frontend.md](./frontend.md). Use `$axis-frontend-feature` for the repeatable workflow.

Open [frontend.md](./frontend.md) for feature folder structure, TanStack Query, TypeScript discipline, routing, testing, visual states, and build commands. Keep frontend-specific examples there so this pattern reference stays backend/platform focused.

## Wireframe convention

Wireframe source and workflow rules live in [wireframes.md](./wireframes.md), [docs-style.md](./docs-style.md#use-case-files--wireframes--implementation-status), and [visual-artifact-checklist.md](./visual-artifact-checklist.md). Use `$axis-visual-artifact` when changing wireframes, generated SVG previews, Mermaid diagrams, or visual docs.
