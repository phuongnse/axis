...
| Shell adapters | Active shell plus `processctl doctor --project-root . --profile development` | `DOCKER_HOST` or `PATH` only when the owning native runtime resolves from another context. |
