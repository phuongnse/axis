...
| Diagram | Owner |
|---|---|
| Tenant onboarding journey | [register-tenant § Diagrams](./use-cases/platform-foundation/register-tenant/README.md#diagrams) |
...
|----------|----------------|
| [register-tenant § Wireframes](./use-cases/platform-foundation/register-tenant/README.md#wireframes) | Multi-screen Tenant onboarding path, error `*-states`, links to Mermaid diagrams |
