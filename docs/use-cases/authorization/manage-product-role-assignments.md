...
| AT-005 | Browser journey | Administrator assigns and revokes exact roles with accessible selection, pending, conflict, recovery, and canonical revision/modified-only collection metadata | AC-004, AC-010, AC-011, AC-014 | UI component test + Browser automation | Yes |
