...
> | Frontend | ⏳ |
>
> **Gaps vs spec:** **Registration (slice 2 — legal + slug on this PR):** Terms acceptance, `GET /api/legal/versions`, slug preview on register. **Not yet:** SSO/register-org-complete, post-submit journey (slice 1), verify PKCE (slice 3), manual retry (slice 4). [pr-slicing.md](../../../playbooks/pr-slicing.md). **Email verification / tenant provisioning (backend ✅).** **Frontend ⏳:** register form updated; journey screens in slice 1.
>
> **Decisions:**
