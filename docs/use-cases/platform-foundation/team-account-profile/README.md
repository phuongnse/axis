# Use case — Update team account profile

> **Navigation**: [← Platform Foundation](../README.md) · [Use cases index](../README.md#use-cases)

## Purpose

Update my team account's name and logo so that the platform reflects our brand.
...
- User initiates: update my team account's name and logo
...
*Happy path*
- [ ] Admin can update: team account name, logo, timezone, and default language from the Settings page.
...
*Validation & errors*
- [ ] Team account name: required, 2–100 characters. Inline error shown if violated.
...
- [ ] Team account name change does not affect the internal schema name (slug), which is immutable after provisioning.
...
>
> **Done:** `Team account` profile fields + `UpdateTeam accountProfileCommand`; S3 logo storage; IANA timezone validation.

## Wireframes

| Screen | Excalidraw | Preview |
|--------|------------|---------|
| settings-team-account-profile-states | [source](./settings-team-account-profile-states.excalidraw) | [preview](./settings-team-account-profile-states.svg) |
