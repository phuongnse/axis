...
| AT-002 | `frontend/e2e/sign-in-user.pw.ts`, `frontend/tests/auth-session-restore.test.ts`, `tests/Api/Axis.Api.Tests/Identity/SignInUserFlowTests.cs` | `python scripts/axis.py local-dev e2e -- e2e/sign-in-user.pw.ts -g AT-002`, `python scripts/axis.py frontend script test tests/auth-session-restore.test.ts`, `python scripts/axis.py dotnet test tests/Api/Axis.Api.Tests/Axis.Api.Tests.csproj` |
...
| AT-013 | `frontend/e2e/sign-in-user.pw.ts`, `frontend/tests/auth-session-restore.test.ts` | `python scripts/axis.py local-dev e2e -- e2e/sign-in-user.pw.ts`, `python scripts/axis.py frontend script test tests/auth-session-restore.test.ts` |
...
| AT-015 | `frontend/e2e/sign-in-user.pw.ts`, `frontend/tests/auth-session-restore.test.ts`, `tests/Api/Axis.Api.Tests/Identity/SignInUserFlowTests.cs` | `python scripts/axis.py local-dev e2e -- e2e/sign-in-user.pw.ts -g AT-015`, `python scripts/axis.py frontend script test tests/auth-session-restore.test.ts`, `python scripts/axis.py dotnet test tests/Api/Axis.Api.Tests/Axis.Api.Tests.csproj` |
