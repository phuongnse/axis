...
| AT-016 | `frontend/e2e/sign-in-user.pw.ts`, `frontend/tests/auth-session-restore.test.ts`, `frontend/tests/callback-page.test.tsx` | `python scripts/axis.py local-dev e2e -- e2e/sign-in-user.pw.ts -g AT-001`, `python scripts/axis.py frontend script test tests/auth-session-restore.test.ts tests/callback-page.test.tsx` |
