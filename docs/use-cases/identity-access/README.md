...
| **Frontend** | ⚠️ partial | User registration, settings, invitation accept, session management UI, and multi-tab refresh remain open. Localization/theming foundation is shipped — see [language](./language/) and [theme](./theme/). |
