# Use case — Invite a user to the team account
...
- [ ] Inviting an email already belonging to an active member of the team account returns: "This user is already a member."
...
- [ ] The user limit check is performed at invitation time, not at acceptance time. If the team account is at its user limit, the invitation is blocked with an upgrade prompt.
...
>
> **Deferred follow-ups:** Bulk invitation via CSV upload.
>
