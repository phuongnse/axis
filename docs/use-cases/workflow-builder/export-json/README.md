...
2. System verifies the actor has `workflow:definition:read` for the workflow's team account.
...
7. Actor can store the file as a backup or share it for import into another Axis team account.
