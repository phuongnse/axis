...
- [ ] A workflow exported as JSON can be imported into another team account and runs correctly.
...
| **Frontend** | ⏳ | Visual canvas, step config panels, trigger UI — every team account-management–import-export US. |
