...
2. System validates the name and plan limit, creates a Draft workflow with Start and End nodes, and persists it for the Workspace.
...
*Validation & errors*
- [ ] Name: required, 2–200 characters, unique within the workspace (case-insensitive). Duplicate shows: "A workflow named '{name}' already exists."
