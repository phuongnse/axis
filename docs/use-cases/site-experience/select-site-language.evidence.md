...
|---|---|---|
| AT-001 | `frontend/e2e/select-site-language.pw.ts` | `python scripts/axis.py frontend script test:e2e -- e2e/select-site-language.pw.ts` |
| AT-002 | `frontend/e2e/select-site-language.pw.ts`, `tests/Api/Axis.Api.Tests/Identity/UserLanguagePreferenceEndpointTests.cs` | `python scripts/axis.py frontend script test:e2e -- e2e/select-site-language.pw.ts`, `python scripts/axis.py dotnet test tests/Api/Axis.Api.Tests/Axis.Api.Tests.csproj` |
