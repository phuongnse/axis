# Use Case Group — Workflow Step Integration

## Wireframes

| Screen | Excalidraw | Preview |
|--------|------------|---------|
| forms | [source](../../epics/E05-form-builder/wireframes/forms.excalidraw) | [preview](../../epics/E05-form-builder/wireframes/forms.svg) |
