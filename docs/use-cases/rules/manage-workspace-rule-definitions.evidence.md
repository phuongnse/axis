...
| AT-003, AT-004 | `tests/Modules/Rules/Axis.Rules.Application.Tests/RuleDefinitionHandlerTests.cs`, `tests/Modules/Rules/Axis.Rules.Application.Tests/RuleEvaluatorTests.cs` | `python scripts/axis.py dotnet test tests/Modules/Rules/Axis.Rules.Application.Tests/Axis.Rules.Application.Tests.csproj` |
...
| AT-007 | `tests/Modules/Rules/Axis.Rules.Application.Tests/RuleDefinitionHandlerTests.cs`, `tests/Api/Axis.Api.Tests/Rules/RuleDefinitionEndpointTests.cs` | `python scripts/axis.py dotnet test tests/Modules/Rules/Axis.Rules.Application.Tests/Axis.Rules.Application.Tests.csproj`, `python scripts/axis.py dotnet test tests/Api/Axis.Api.Tests/Axis.Api.Tests.csproj` |
