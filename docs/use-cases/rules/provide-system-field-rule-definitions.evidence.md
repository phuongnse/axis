...
|---|---|---|
| AT-001 | `tests/Modules/Rules/Axis.Rules.Domain.Tests/SystemRuleCatalogTests.cs`, `tests/Modules/Rules/Axis.Rules.Domain.Tests/RuleValueTests.cs` | `python scripts/axis.py dotnet test tests/Modules/Rules/Axis.Rules.Domain.Tests/Axis.Rules.Domain.Tests.csproj` |
| AT-002, AT-003 | `tests/Modules/Rules/Axis.Rules.Application.Tests/RuleApplicationValidatorTests.cs`, `tests/Modules/Rules/Axis.Rules.Application.Tests/RuleEvaluatorTests.cs` | `python scripts/axis.py dotnet test tests/Modules/Rules/Axis.Rules.Application.Tests/Axis.Rules.Application.Tests.csproj` |
...
| AT-006 | `frontend/tests/rules-page.test.tsx`, `frontend/e2e/app-frame.pw.ts` | `python scripts/axis.py frontend script test -- rules-page.test.tsx`, `python scripts/axis.py frontend script test:e2e -- app-frame.pw.ts` |
