...
| Domain | Scope |
|--------|--------|
| [platform-foundation](./platform-foundation/README.md) | Tenant registration, team account management, isolation, subscription plans |
