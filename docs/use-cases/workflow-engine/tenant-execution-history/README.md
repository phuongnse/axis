# Use case — View tenant-wide execution history
...
1. Actor starts the — View tenant-wide execution history flow from the relevant Axis screen or API.
...
*Edge cases*
- [ ] Admins see all tenant executions. Editors and Viewers see only executions they triggered or were assigned to (form tasks). The API enforces this scope.
...
>
> **Done:** `GET /api/executions` tenant-wide list (paginated).
>
> **Gaps vs spec:**
> - N/A
>
