# Use case — View team account-wide execution history
...
*Edge cases*
- [ ] Admins see all team account executions. Editors and Viewers see only executions they triggered or were assigned to (form tasks). The API enforces this scope.
...
>
> **Done:** `GET /api/executions` team account-wide list (paginated).
