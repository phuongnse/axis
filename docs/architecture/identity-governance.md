...
- Completion idempotently revokes the source ticket. Cleanup failure cannot restore source authority because every request checks transition state before Workspace data access.
